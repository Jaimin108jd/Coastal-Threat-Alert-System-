...
export async function GET() {
    ...
    // there might be  a catch let me explain if user has already in db and the auth service they opt to login through a provider (like google in this case it would overwrite.)
