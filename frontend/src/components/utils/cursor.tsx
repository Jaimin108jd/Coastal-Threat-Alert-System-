    ...
    return (
        ...
        >
            <div
                ...
                style={{
                    background: 'radial-gradient(circle, rgba(1, 222, 130, 0.3) 0%, rgba(5, 97, 75, 0.15) 50%, transparent 70%)',
            ...
            <div
                ...
                style={{
                    background: 'radial-gradient(circle, rgba(1, 222, 130, 0.4) 0%, transparent 60%)',
